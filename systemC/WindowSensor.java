...
class WindowSensor
{
	...
	public WindowSensor(String title, float winPosX, float winPosY, final MessageManagerInterface em) {
		...
		button.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				...
				{
					em.SendMessage( msg );
					mw.WriteMessage("Detected Window Break!");
				} // try
				catch (Exception e)
				{
					System.out.println( "Window Sensor Error:: " + e );
				} // catch
			}
		});
	...
	public static void main(String args[])
	{
		...
		if (em != null)
		{
			...
			WindowSensor sensor = new WindowSensor("Window Sensor", WinPosX, WinPosY, em);
			...
			{
				// Detect Heartbeat
				ServiceMonitor.detectHeartbeat(em, "WS01 - Window Sensor");
